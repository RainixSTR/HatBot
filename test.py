...
class BotTests(unittest.TestCase):
    ...
    def test_get_data(self):
        ...
        url_1 = 'https://www.meteoservice.ru/weather/overview/sankt-peterburg'

        data_1 = main.get_data(url_1)
        response = requests.get(url_1)
        self.assertEqual(response.status_code, 200)

        url_2 = 'https://www.meteoservice.ru/weather/overview/moskva'
    ...
    def test_get_advice(self):
        ...
        self.assertEqual('Думаю, сегодня точно стоит надеть шапку', advice_1)
        self.assertEqual('Тепло! Можно походить без шапочки ;)', advice_2)
